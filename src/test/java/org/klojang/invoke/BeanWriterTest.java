...
public class BeanWriterTest {
  ...
  public void set00() throws Throwable {
    ...
    org.klojang.invoke.BeanWriter writer = new org.klojang.invoke.BeanWriter(Person.class);
  ...
  public void set03() throws Throwable {
    ...
    } catch (org.klojang.invoke.IllegalAssignmentException e) {
  ...
  @Test(expected = org.klojang.invoke.IllegalAssignmentException.class)
  ...
  public void mapEnrich00() throws Throwable {
    ...
    org.klojang.invoke.BeanWriter writer = new BeanWriter(Person.class,
        INCLUDE,
        "id",
        "firstName",
        "lastName",
